...
texture = shaders.create_ND_subtract_float(stage, material,'my_subtract_float', in1=texture1, in2=texture2)
...
texture = shaders.create_ND_subtract_vector2(stage, material,'my_subtract_vector2', in1=texture1, in2=texture2)
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.7,1.0,0.5), color_B=(0,0,0))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(0,.3,0.5), color_B=(0,0,0))
texture = shaders.create_ND_subtract_vector3(stage, material,'my_subtract_vector3', in1=texture1, in2=texture2)
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
texture = shaders.create_ND_subtract_vector4(stage, material,'my_subtract_vector4', in1=texture1, in2=texture2)
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.7,1.0,0.5), color_B=(0,0,0))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(0,.3,0.5), color_B=(0,0,0))
texture = shaders.create_ND_subtract_color3(stage, material,'my_subtract_color3', in1=texture1, in2=texture2)
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
texture1 = shaders.create_TestVec4fOutputMap(stage, material,'convertToRgba1', inAttr=texture1)
texture2 = shaders.create_TestVec4fOutputMap(stage, material,'convertToRgba2', inAttr=texture2)
texture = shaders.create_ND_subtract_color4(stage, material,'my_subtract_color4', in1=texture1, in2=texture2)
# convert the Rgba to a Color
texture = shaders.create_TestInputsMap(stage, material,'convertToColor', inRgba=texture, select="Rgba")
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
...
texture = shaders.create_ND_subtract_matrix33(stage, material,'my_subtract_matrix33', in1=texture1, in2=texture2)
...
texture = shaders.create_ND_subtract_matrix44(stage, material,'my_subtract_matrix44', in1=texture1, in2=texture2)
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.7,1.0,0.5), color_B=(0,0,0))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(0,.3,0.5), color_B=(0,0,0))
texture = shaders.create_ND_subtract_vector2FA(stage, material,'my_subtract_vector2FA', in1=texture1, in2=texture2)
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.7,1.0,0.5), color_B=(0,0,0))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(0,.3,0.5), color_B=(0,0,0))
texture = shaders.create_ND_subtract_vector3FA(stage, material,'my_subtract_vector3FA', in1=texture1, in2=texture2)
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
# convert Color to Rgba
texture1 = shaders.create_TestVec4fOutputMap(stage, material,'convertToRgba1', inAttr=texture1)
texture = shaders.create_ND_subtract_vector4FA(stage, material,'my_subtract_vector4FA', in1=texture1, in2=texture2)
# convert the Rgba to a Color
texture = shaders.create_TestInputsMap(stage, material,'convertToColor', inRgba=texture, select="Rgba")
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.7,1.0,0.5), color_B=(0,0,0))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(0,.3,0.5), color_B=(0,0,0))
texture = shaders.create_ND_subtract_color3FA(stage, material,'my_subtract_color3FA', in1=texture1, in2=texture2)
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
# convert Color to Rgba
texture1 = shaders.create_TestVec4fOutputMap(stage, material,'convertToRgba1', inAttr=texture1)
texture = shaders.create_ND_subtract_color4FA(stage, material,'my_subtract_color4FA', in1=texture1, in2=texture2)
# convert the Rgba to a Color
texture = shaders.create_TestInputsMap(stage, material,'convertToColor', inRgba=texture, select="Rgba")
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
...
# convert Color to Mat3f
texture1 = shaders.create_TestMat3fOutputMap(stage, material,'convertToMat3f1', inAttr=texture1)
texture = shaders.create_ND_subtract_matrix33FA(stage, material,'my_subtract_matrix33FA', in1=texture1, in2=texture2)
# convert the Mat3f to a Color
texture = shaders.create_TestInputsMap(stage, material,'convertToColor', inMat3f=texture, select="Mat3f")
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
...
# convert Color to Mat4f
texture1 = shaders.create_TestMat4fOutputMap(stage, material,'convertToMat4f1', inAttr=texture1)
texture = shaders.create_ND_subtract_matrix44FA(stage, material,'my_subtract_matrix44FA', in1=texture1, in2=texture2)
# convert the Mat4f to a Color
texture = shaders.create_TestInputsMap(stage, material,'convertToColor', inMat4f=texture, select="Mat4f")
emissive = shaders.create_DwaEmissiveMaterial(stage, material, 'MyMaterialShader', emission=texture)
material.CreateSurfaceOutput().ConnectToSource(emissive.ConnectableAPI(), "surface")
