...
/// @file adobergb_to_lin_rec709.cc
...
{
    // the functions pointers on are unions so it doesn't
...
IN_TYPE
doAdobergbToLinRec709(IN_TYPE inValue)
{
    ...
    const float gamma = 563.0f / 256.0f;
