...
/// @file g18_rec709_to_lin_rec709.cc
...
#define OPERATION g18_rec709_to_lin_rec709
...
{
    // Gamma 1.8 Rec.709 to Linear Rec.709
    // Apply inverse gamma of 1.8 to linearize
    ...
    outValue.r = scene_rdl2::math::pow(outValue.r, 1.8f);
    outValue.g = scene_rdl2::math::pow(outValue.g, 1.8f);
    outValue.b = scene_rdl2::math::pow(outValue.b, 1.8f);
