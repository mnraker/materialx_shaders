...
#define OPERATION g22_rec709_to_lin_rec709
...
IN_TYPE
doG22Rec709ToLinRec709(IN_TYPE inValue)
{
    // Gamma 2.2 Rec.709 to Linear Rec.709
    // Apply inverse gamma of 2.2 to linearize
    ...
    outValue.r = scene_rdl2::math::pow(outValue.r, 2.2f);
    outValue.g = scene_rdl2::math::pow(outValue.g, 2.2f);
    outValue.b = scene_rdl2::math::pow(outValue.b, 2.2f);
                    ...
                    const moonray::shading::State& state, RETURN_TYPE* sample)
{
    ...
    if (!me->mIspc.disableMode) {
        outValue = doG22Rec709ToLinRec709(inValue);
    }
