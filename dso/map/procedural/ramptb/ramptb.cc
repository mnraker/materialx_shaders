                 ...
                 const moonray::shading::State& state, RETURN_TYPE* sample)
{
    ...
    IN_TYPE out = me->mIspc.disableMode ? OUT_DEFAULT : lerp(valuet, valueb, v);
