...
MTLX_ATTR_DEFINE_BEGIN
    ...
    positionAttr = sceneClass.declareAttribute<Vec3f>("position", POSITION_DEFAULT_VEC3F, FLAGS_BINDABLE, INTERFACE_GENERIC, {});
                    ...
                    RETURN_TYPE* sample)
{
    ...
    //
	// Convert the output value to the appropriate return type
	//
