...
MTLX_ATTR_DEFINE_BEGIN
    ...
    sizeAttr = sceneClass.declareAttribute<Float>("size", 0.0f, FLAGS_BINDABLE, INTERFACE_GENERIC, {});
    filtertypeAttr = sceneClass.declareAttribute<Int>("filtertype", 0, FLAGS_BINDABLE, INTERFACE_GENERIC, {});
                    ...
                    const moonray::shading::State& state, RETURN_TYPE* sample)
{
    ...
    IN_TYPE inValue = IN_EVAL(me, inAttr, tls, state);
