...
stage = Usd.Stage.CreateNew('Test_ND_safepower.usda')
...
texture = shaders.create_ND_safepower_float(stage, material,'my_safepower_float', in1=texture1, in2=texture2)
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.9,0.8,0.7), color_B=(0.6,0.5,0.4))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(1.0,2.0,3.0), color_B=(3.0,1.0,2.0))
texture = shaders.create_ND_safepower_vector2(stage, material,'my_safepower_vector2', in1=texture1, in2=texture2)
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)

#
# ND_safepower_vector3
#
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.9,0.8,0.7), color_B=(0.6,0.5,0.4))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(1.0,2.0,3.0), color_B=(3.0,1.0,2.0))
texture = shaders.create_ND_safepower_vector3(stage, material,'my_safepower_vector3', in1=texture1, in2=texture2)
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
texture = shaders.create_ND_safepower_vector4(stage, material,'my_safepower_vector4', in1=texture1, in2=texture2)
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.9,0.8,0.7), color_B=(0.6,0.5,0.4))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(1.0,2.0,3.0), color_B=(3.0,1.0,2.0))
texture = shaders.create_ND_safepower_color3(stage, material,'my_safepower_color3', in1=texture1, in2=texture2)
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
texture1 = shaders.create_TestVec4fOutputMap(stage, material,'convertToRgba1', inAttr=texture1)
texture2 = shaders.create_TestVec4fOutputMap(stage, material,'convertToRgba2', inAttr=texture2)
texture = shaders.create_ND_safepower_color4(stage, material,'my_safepower_color4', in1=texture1, in2=texture2)
# convert the Rgba to a Color
texture = shaders.create_TestInputsMap(stage, material,'convertToColor', inRgba=texture, select="Rgba")
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
...
texture = shaders.create_ND_safepower_vector2FA(stage, material,'my_safepower_vector2FA', in1=texture1, in2=texture2)
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)

#
# ND_safepower_vector3FA
#
index+=1
testName= '/MyMaterialTest'+str(index)
material = UsdShade.Material.Define(stage,testName)
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.9,0.8,0.7), color_B=(0.6,0.5,0.4))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(1.0,2.0,3.0), color_B=(3.0,1.0,4.0))
texture = shaders.create_ND_safepower_vector3FA(stage, material,'my_safepower_vector3FA', in1=texture1, in2=texture2)
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)

#
# ND_safepower_vector4FA
#
index+=1
testName= '/MyMaterialTest'+str(index)
material = UsdShade.Material.Define(stage,testName)
...
# convert Color to Rgba
texture1 = shaders.create_TestVec4fOutputMap(stage, material,'convertToRgba1', inAttr=texture1)
texture = shaders.create_ND_safepower_vector4FA(stage, material,'my_safepower_vector4FA', in1=texture1, in2=texture2)
# convert the Rgba to a Color
texture = shaders.create_TestInputsMap(stage, material,'convertToColor', inRgba=texture, select="Rgba")
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
...
texture1 = shaders.create_CheckerboardMap(stage,material,'checkerboard1', num_u_tiles=2, num_v_tiles=2, color_A=(0.9,0.8,0.7), color_B=(0.6,0.5,0.4))
texture2 = shaders.create_CheckerboardMap(stage,material,'checkerboard2', num_u_tiles=4, num_v_tiles=4, color_A=(1.0,2.0,3.0), color_B=(3.0,1.0,4.0))
texture = shaders.create_ND_safepower_color3FA(stage, material,'my_safepower_color3FA', in1=texture1, in2=texture2)
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
UsdShade.MaterialBindingAPI(geometry[index]).Bind(material)
...
# convert Color to Rgba
texture1 = shaders.create_TestVec4fOutputMap(stage, material,'convertToRgba1', inAttr=texture1)
texture = shaders.create_ND_safepower_color4FA(stage, material,'my_safepower_color4FA', in1=texture1, in2=texture2)
# convert the Rgba to a Color
texture = shaders.create_TestInputsMap(stage, material,'convertToColor', inRgba=texture, select="Rgba")
pbrShader = shaders.create_UsdPreviewSurface(stage, material,'MyMaterialShader', roughness=0.4, metallic=0.0, diffuseColor=texture)
material.CreateSurfaceOutput().ConnectToSource(pbrShader.ConnectableAPI(), "surface")
